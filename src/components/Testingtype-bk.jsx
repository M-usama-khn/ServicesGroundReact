                ...
                <div className="w-layout-grid taf_layout">
                    ...
                    <div id="w-node-_6c6294b4-ed58-bded-2c08-58632da1cab7-3774a0db" data-w-id="6c6294b4-ed58-bded-2c08-58632da1cab7"  className="w-layout-grid tp-layout">
                        <div  id="w-node-c15f0759-41ec-5636-7b5a-1d27a079d769-3774a0db" className="tp-circle">
                            {/* <img src="https://uploads-ssl.webflow.com/612f8414a3e5101241cc446e/61de83a585b7e760d0f5d131_devlane-qa-software-testing-process-decoration-dotted-elipse.svg" loading="lazy" alt="Decorative dotted circle" className="tp-circle-img" /> */}
                        ...
                        <div style={{display : `${ props.page == "email" ? "none" : "block"}`}}id="w-node-eb3730fd-5ff7-5e43-e294-f03c3386e871-3774a0db" className="tp-rounded-corner"></div>
                        <div style={{display : `${ props.page == "email" ? "none" : "block"}`}} id="w-node-c0dfea0a-fd8f-139d-935c-bac66b675c7f-3774a0db" className="tp-line"></div>
                        <div style={{display : `${ props.page == "email" ? "none" : "block"}`}} id="w-node-c065d394-a6a5-3cd6-3ff3-5e5e2caebb0c-3774a0db" className="tp-rounded-corner down"></div>
                        <div style={{display : `${ props.page == "email" ? "none" : "block"}`}}id="w-node-_54044a93-ee46-be1d-f018-4480af223d0c-3774a0db" className="tp-item">
                            <div className="w-layout-grid tp-item-grid right" style={{display : `${ props.page == "email" ? "none" : "block"}`}}>
                        ...
                        {/* <img src="https://uploads-ssl.webflow.com/612f8414a3e5101241cc446e/61de83a585b7e760d0f5d131_devlane-qa-software-testing-process-decoration-dotted-elipse.svg" loading="lazy" id="w-node-_60166113-0e6f-8727-c542-97d85144c2db-3774a0db" alt="Decorative dotted circle"
                        ...
                        <div style ={{ display : `${props.page == "email" ? "none" : "block"}` }} id="w-node-_252d4fe4-79ff-ddf9-9621-25ad5d170ba7-3774a0db" className="tp-rounded-corner left"></div>
                        <div style ={{ display : `${props.page == "email" ? "none" : "block"}` }} id="w-node-_4e1655ce-fe1c-a91a-a534-b0eb77043679-3774a0db" className="tp-line"></div>
                        <div style ={{ display : `${props.page == "app" ? "none" : props.page == "email" ? "none":"block"}` }} id="w-node-_1f87528e-a7c6-04d5-d94e-70623bdbc6df-3774a0db" className="tp-rounded-corner downright"></div>
                        <div id="w-node-cec246d6-202a-b490-65f2-8433f095250e-3774a0db" className="tp-vertical-line right"></div>
                        <div id="w-node-c4b8dd2e-1fa1-0f0e-b7e1-2166fc768852-3774a0db" className="tp-item">
                            <div className="w-layout-grid tp-item-grid" style={{display : `${ props.page == "email" ? "none" : props.page == "app" ? "none" : "block"}`}}>
                        ...
                        {/* <img src="https://uploads-ssl.webflow.com/612f8414a3e5101241cc446e/61de83a585b7e760d0f5d131_devlane-qa-software-testing-process-decoration-dotted-elipse.svg" loading="lazy" id="w-node-_5dd32a5c-135e-5b10-a781-179788912f52-3774a0db" alt="Decorative dotted circle"
                            className="tp-circle-img" /> */}
                        <div style ={{ display : `${props.page == "app" ? "none" :props.page == "email" ? "none" :"block"}` }} id="w-node-_688bc6ff-9219-9bc3-13a5-f5dd9cb778dc-3774a0db" className="tp-rounded-corner"></div>
                        <div style ={{ display : `${props.page == "app" ? "none" : props.page == "email" ? "none":"block"}` }} id="w-node-e89b4f64-7d01-e8c4-7691-5a69bfdffaab-3774a0db" className="tp-line"></div>
                        <div style ={{ display : `${props.page == "app" ? "none" : props.page == "email" ? "none" : "block"}` }}  id="w-node-f42a7850-8904-c0f2-9e35-5aca45d699e2-3774a0db" className="tp-rounded-corner down"></div>
                        <div id="w-node-_94721896-f80c-d5e7-72a8-4e373a45fa60-3774a0db" className="tp-vertical-line last"></div>
                        {/* <img src="https://uploads-ssl.webflow.com/612f8414a3e5101241cc446e/61de83a585b7e760d0f5d131_devlane-qa-software-testing-process-decoration-dotted-elipse.svg" loading="lazy" id="w-node-_475e57aa-74e1-1707-75d0-bfc438aafd1a-3774a0db" alt="Decorative dotted circle"
                            className="tp-circle-img" /> */}
                        <div id="w-node-_1f6af910-ea0b-814a-4bc5-761afe58aaea-3774a0db" className="tp-item">
                            <div className="w-layout-grid tp-item-grid right" style={{display : `${ props.page == "media" ? "none" : props.page == "email" ? "none" :  props.page == "app" ? "none" :"block"}`}}>
